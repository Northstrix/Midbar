...
int generate_random_number() {
  return ESP8266TrueRandom.random(256);
}
...
void enter_title_for_login(int chsn_slot) {
  ...
  nunchuk_input();
  if (act == true) {
    enter_username_for_login(chsn_slot, wii_nunch_input);
  }
  return;
}
...
void enter_username_for_login(int chsn_slot, String entered_title) {
  ...
  nunchuk_input();
  if (act == true) {
    enter_password_for_login(chsn_slot, entered_title, wii_nunch_input);
  }
  return;
}
...
void enter_password_for_login(int chsn_slot, String entered_title, String entered_username) {
  ...
  nunchuk_input();
  if (act == true) {
    enter_website_for_login(chsn_slot, entered_title, entered_username, wii_nunch_input);
  }
  return;
}
...
void enter_website_for_login(int chsn_slot, String entered_title, String entered_username, String entered_password) {
  ...
  nunchuk_input();
  if (act == true) {
    write_login_to_flash(chsn_slot, entered_title, entered_username, entered_password, wii_nunch_input);
  }
  return;
}
...
void edit_login_from_keyboard_and_encdr(int chsn_slot) {
  if (read_file(SPIFFS, "/L" + String(chsn_slot) + "_psw") == "-1") {
    ...
    tft.setTextSize(1);
    tft.setTextColor(0xffff);
    disp_centered_text("Press Any Button", 110);   disp_centered_text("To Cancel", 120);
    ...
    wii_nunch_input = old_password;
    disp();
    nunchuk_input();
    if (act == true) {
      update_login_and_tag(chsn_slot, wii_nunch_input);
    }
  }
  return;
}
...
void enter_title_for_credit_card(int chsn_slot) {
  ...
  nunchuk_input();
  if (act == true) {
    enter_cardholder_for_credit_card(chsn_slot, wii_nunch_input);
  }
  return;
}
...
void enter_cardholder_for_credit_card(int chsn_slot, String entered_title) {
  ...
  nunchuk_input();
  if (act == true) {
    enter_card_number_for_credit_card(chsn_slot, entered_title, wii_nunch_input);
  }
  return;
}
...
void enter_card_number_for_credit_card(int chsn_slot, String entered_title, String entered_cardholder) {
  ...
  nunchuk_input();
  if (act == true) {
    enter_expiry_for_credit_card(chsn_slot, entered_title, entered_cardholder, wii_nunch_input);
  }
  return;
}
...
void enter_expiry_for_credit_card(int chsn_slot, String entered_title, String entered_cardholder, String entered_card_number) {
  ...
  nunchuk_input();
  if (act == true) {
    enter_cvn_for_credit_card(chsn_slot, entered_title, entered_cardholder, entered_card_number, wii_nunch_input);
  }
  return;
}
...
void enter_cvn_for_credit_card(int chsn_slot, String entered_title, String entered_cardholder, String entered_card_number, String entered_expiry) {
  ...
  nunchuk_input();
  if (act == true) {
    enter_pin_for_credit_card(chsn_slot, entered_title, entered_cardholder, entered_card_number, entered_expiry, wii_nunch_input);
  }
  return;
}
...
void enter_pin_for_credit_card(int chsn_slot, String entered_title, String entered_cardholder, String entered_card_number, String entered_expiry, String entered_cvn) {
  ...
  nunchuk_input();
  if (act == true) {
    enter_zip_code_for_credit_card(chsn_slot, entered_title, entered_cardholder, entered_card_number, entered_expiry, entered_cvn, wii_nunch_input);
  }
  return;
}
...
void enter_zip_code_for_credit_card(int chsn_slot, String entered_title, String entered_cardholder, String entered_card_number, String entered_expiry, String entered_cvn, String entered_pin) {
  ...
  nunchuk_input();
  if (act == true) {
    write_credit_card_to_flash(chsn_slot, entered_title, entered_cardholder, entered_card_number, entered_expiry, entered_cvn, entered_pin, wii_nunch_input);
  }
  return;
}
...
void edit_credit_card_from_keyboard_and_encdr(int chsn_slot) {
  if (read_file(SPIFFS, "/C" + String(chsn_slot) + "_pin") == "-1") {
    ...
    wii_nunch_input = old_pin;
    disp();
    nunchuk_input();
    if (act == true) {
      update_credit_card_and_tag(chsn_slot, wii_nunch_input);
    }
  }
  return;
}
...
void enter_title_for_note(int chsn_slot) {
  ...
  nunchuk_input();
  if (act == true) {
    enter_content_for_note(chsn_slot, wii_nunch_input);
  }
  return;
}
...
void enter_content_for_note(int chsn_slot, String entered_title) {
  ...
  nunchuk_input();
  if (act == true) {
    write_note_to_flash(chsn_slot, entered_title, wii_nunch_input);
  }
  return;
}
...
void edit_note_from_keyboard_and_encdr(int chsn_slot) {
  if (read_file(SPIFFS, "/N" + String(chsn_slot) + "_cnt") == "-1") {
    ...
    nunchuk_input();
    if (act == true) {
      update_note_and_tag(chsn_slot, wii_nunch_input);
    }
  }
  return;
}
...
void enter_title_for_phone_number(int chsn_slot) {
  ...
  nunchuk_input();
  if (act == true) {
    enter_phone_number_for_phone_number(chsn_slot, wii_nunch_input);
  }
  return;
}
...
void enter_phone_number_for_phone_number(int chsn_slot, String entered_title) {
  ...
  nunchuk_input();
  if (act == true) {
    write_phone_number_to_flash(chsn_slot, entered_title, wii_nunch_input);
  }
  return;
}
...
void edit_phone_number_from_keyboard_and_encdr(int chsn_slot) {
  if (read_file(SPIFFS, "/P" + String(chsn_slot) + "_cnt") == "-1") {
    ...
    nunchuk_input();
    if (act == true) {
      update_phone_number_and_tag(chsn_slot, wii_nunch_input);
    }
  }
  return;
}
...
void up_or_encdr_bttn_to_print() {
  ...
  while (break_the_loop == false) {
    ...
    delayMicroseconds(read_nunchuk_delay);
  }
}
...
void set_psswd() {
  int str_len = wii_nunch_input.length() + 1;
  char input_arr[str_len];
  wii_nunch_input.toCharArray(input_arr, str_len);
  std::string str = "";
  if (str_len > 1) {
...
void input_source_for_data_in_flash_menu(int curr_pos) {
  ...
  if (curr_pos == 0) {
    tft.setTextColor(0xffff);
    disp_centered_text("Wii Nunchuk", sdown + 10);
    tft.setTextColor(current_inact_clr);
...
void hash_with_sha256() {
  ...
  wii_nunch_input.toCharArray(keyb_inp_arr, str_len);
  SHA256 hasher;
