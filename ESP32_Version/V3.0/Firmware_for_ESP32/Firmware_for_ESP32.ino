...
String kderalgs = "8z38sbv3VdM0t319ZKFSeN6DD7X";
int numofkincr = 737;
byte hmackey[] = {"k524YLWp4cJwlXrq8WAM33ywIDauiBhfSaxm8WRDgTL1cEgf05NZ7A8UER9w39d10g2J8rQIHyEc1l4tFwoj72E3vfDB9KG7bwifMEwQ670Kkvh1005K3GzZ0N0l"};
byte des_key[] = {
0x10,0x45,0x7c,0x03,0x2f,0x1d,0xfb,0x0e,
0xa2,0xd3,0x95,0xe2,0xdd,0xe7,0xbf,0xcb,
0xde,0x9c,0x69,0x8a,0xef,0x9f,0x0b,0xa4
};
uint8_t AES_key[32] = {
0xa5,0xa4,0x0b,0x3e,
0x6b,0xa1,0x58,0x1b,
  ...
  while (break_the_loop == false) {
    ...
    if (chosen_lock_screen == 0) {
      for (int i = 0; i < 306; i++) {
        for (int j = 0; j < 77; j++) {
          if (mdb_icon[i][j] == 1)
            tft.drawPixel(i + 7, j + 87, Dallas[(i + 7 + k) % 320][j + 87]);
        }
      }
    }
    ...
    if (chosen_lock_screen == 1) {
      for (int i = 0; i < 306; i++) {
        for (int j = 0; j < 77; j++) {
          if (mdb_icon[i][j] == 1)
            tft.drawPixel(i + 7, j + 87, Tel_Aviv[(i + 7 + k) % 320][j + 87]);
        }
      }
    }
    ...
    if (chosen_lock_screen == 2) {
      for (int i = 0; i < 306; i++) {
        for (int j = 0; j < 77; j++) {
          if (mdb_icon[i][j] == 1)
            tft.drawPixel(i + 7, j + 87, Montreal[(i + 7 + k) % 320][j + 87]);
        }
      }
    }
    ...
    if (chosen_lock_screen == 3) {
      for (int i = 0; i < 306; i++) {
        for (int j = 0; j < 77; j++) {
          if (mdb_icon[i][j] == 1)
            tft.drawPixel(i + 7, j + 87, Austin[(i + 7 + k) % 320][j + 87]);
        }
      }
    }
    ...
    if (chosen_lock_screen == 4) {
      for (int i = 0; i < 306; i++) {
        for (int j = 0; j < 77; j++) {
          if (mdb_icon[i][j] == 1)
            tft.drawPixel(i + 7, j + 87, Dallas_2[(i + 7 + k) % 320][j + 87]);
        }
      }
    }
...
void setup(void) {
  ...
  chosen_lock_screen = esp_random() % 5;
  if (chosen_lock_screen == 0) {
    for (int i = 0; i < 320; i++) {
      for (int j = 0; j < 240; j++) {
