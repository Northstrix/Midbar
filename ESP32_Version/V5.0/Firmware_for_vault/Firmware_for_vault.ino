...
0xde,0xdf,0xdb,0xde,0x7d,0xb4,0xe9,0xa7
};
String kderalgs = "p00444v60S25Gv7wzz9Ky83Uhksn6ARkn9H7Acy6rRNl5B4j";
int numofkincr = 261;
byte hmackey[] = {"U7Lu0Eixt6840sDjEKMtz1heQr8DYfWRLmwPuD7m6dXh6wtHp80K0rznK9J44KajvWFoQnU4Xoa61UGmxQQ1QKWHAxUd1T1xi60Pg2l3Rd6wDJS6kaL99b31e0VK2X1r6tQE"};
byte des_key[] = {
0xf1,0xe0,0x3c,0xef,0xc0,0x9d,0xc5,0x4c,
0xde,0xb1,0x3f,0xe0,0xfe,0x1a,0xc1,0x9e,
0x57,0x2d,0x24,0x17,0x74,0xec,0x47,0xed
};
uint8_t AES_key[32] = {
0x1f,0x4e,0x36,0x42,
0x07,0xb9,0x60,0x4d,
...
byte hmackey_for_session_key[] = {"VDA7DYQS3J9dH2083UE2g09ixre8m415snML8uBnPS8WqJ85oAvg922S05HFpQ0v6175617yWAl1I7knVEhF1rmRYLbJRN3EfH5xQ03o88quD0KavnO8sp1uT"};
...
void display_title_from_credit_card_without_integrity_verification() {
  tft.setTextSize(2);
  String encrypted_title = read_file(SD, "/C" + String(curr_key) + "_ttl");
  if (encrypted_title == "-1") {
    tft.setTextColor(0x07e0);
    disp_centered_text("Empty", 35);
  } else {
...
void write_credit_card_to_flash(int chsn_slot, String entered_title, String entered_cardholder, String entered_card_number, String entered_expiry, String entered_cvn, String entered_pin, String entered_zip_code) {
  ...
  */
  ...
  encrypt_with_TDES_AES_Blowfish_Serp(entered_title);
  delay(200);
  write_to_file_with_overwrite(SD, "/C" + String(chsn_slot) + "_ttl", dec_st);
  clear_variables();
  encrypt_with_TDES_AES_Blowfish_Serp(entered_cardholder);
  delay(200);
  write_to_file_with_overwrite(SD, "/C" + String(chsn_slot) + "_hld", dec_st);
  clear_variables();
  encrypt_with_TDES_AES_Blowfish_Serp(entered_card_number);
  delay(200);
  write_to_file_with_overwrite(SD, "/C" + String(chsn_slot) + "_nmr", dec_st);
  clear_variables();
  encrypt_with_TDES_AES_Blowfish_Serp(entered_expiry);
  delay(200);
  write_to_file_with_overwrite(SD, "/C" + String(chsn_slot) + "_exp", dec_st);
  clear_variables();
  encrypt_with_TDES_AES_Blowfish_Serp(entered_cvn);
  delay(200);
  write_to_file_with_overwrite(SD, "/C" + String(chsn_slot) + "_cvn", dec_st);
  clear_variables();
  encrypt_with_TDES_AES_Blowfish_Serp(entered_pin);
  delay(200);
  write_to_file_with_overwrite(SD, "/C" + String(chsn_slot) + "_pin", dec_st);
  clear_variables();
  encrypt_with_TDES_AES_Blowfish_Serp(entered_zip_code);
  delay(200);
  write_to_file_with_overwrite(SD, "/C" + String(chsn_slot) + "_zip", dec_st);
  clear_variables();
  ...
  delay(200);
  write_to_file_with_overwrite(SD, "/C" + String(chsn_slot) + "_tag", dec_st);
  return;
}
...
void update_credit_card_and_tag(int chsn_slot, String new_pin) {
  ...
  write_to_file_with_overwrite(SD, "/C" + String(chsn_slot) + "_pin", dec_st);
  clear_variables();
  decrypt_with_TDES_AES_Blowfish_Serp(read_file(SD, "/C" + String(chsn_slot) + "_ttl"));
  String decrypted_title = dec_st;
  clear_variables();
  decrypt_with_TDES_AES_Blowfish_Serp(read_file(SD, "/C" + String(chsn_slot) + "_hld"));
  String decrypted_cardholder = dec_st;
  clear_variables();
  decrypt_with_TDES_AES_Blowfish_Serp(read_file(SD, "/C" + String(chsn_slot) + "_nmr"));
  String decrypted_card_number = dec_st;
  clear_variables();
  decrypt_with_TDES_AES_Blowfish_Serp(read_file(SD, "/C" + String(chsn_slot) + "_exp"));
  String decrypted_expiry = dec_st;
  clear_variables();
  decrypt_with_TDES_AES_Blowfish_Serp(read_file(SD, "/C" + String(chsn_slot) + "_cvn"));
  String decrypted_cvn = dec_st;
  clear_variables();
  decrypt_with_TDES_AES_Blowfish_Serp(read_file(SD, "/C" + String(chsn_slot) + "_zip"));
...
void edit_credit_card_from_keyboard_and_encdr(int chsn_slot) {
  if (read_file(SD, "/C" + String(chsn_slot) + "_pin") == "-1") {
    ...
    clear_variables();
    decrypt_with_TDES_AES_Blowfish_Serp(read_file(SD, "/C" + String(chsn_slot) + "_pin"));
...
void delete_credit_card(int chsn_slot) {
  ...
  tft.setCursor(0, 10);
  tft.print("Please wait for a while.");
  delete_file(SD, "/C" + String(chsn_slot) + "_tag");
  delete_file(SD, "/C" + String(chsn_slot) + "_ttl");
  delete_file(SD, "/C" + String(chsn_slot) + "_hld");
  delete_file(SD, "/C" + String(chsn_slot) + "_nmr");
  delete_file(SD, "/C" + String(chsn_slot) + "_exp");
  delete_file(SD, "/C" + String(chsn_slot) + "_cvn");
  delete_file(SD, "/C" + String(chsn_slot) + "_pin");
  delete_file(SD, "/C" + String(chsn_slot) + "_zip");
  clear_variables();
  call_main_menu();
  return;
}
...
void view_credit_card(int chsn_slot) {
  if (read_file(SD, "/C" + String(chsn_slot) + "_ttl") == "-1") {
    tft.fillScreen(0x0000);
    tft.setTextColor(0x07e0);
    tft.setTextSize(2);
    disp_centered_text("The Slot N" + String(chsn_slot) + " is Empty", 5);
    ...
    decrypt_with_TDES_AES_Blowfish_Serp(read_file(SD, "/C" + String(chsn_slot) + "_zip"));
    String decrypted_zip_code = dec_st;
    decrypt_tag_with_TDES_AES_Blowfish_Serp(read_file(SD, "/C" + String(chsn_slot) + "_tag"));
...
void display_title_from_note_without_integrity_verification() {
  tft.setTextSize(2);
  String encrypted_title = read_file(SD, "/N" + String(curr_key) + "_ttl");
  if (encrypted_title == "-1") {
    tft.setTextColor(0x07e0);
    disp_centered_text("Empty", 35);
  } else {
...
void write_note_to_flash(int chsn_slot, String entered_title, String entered_content) {
  ...
  encrypt_with_TDES_AES_Blowfish_Serp(entered_title);
  delay(200);
  write_to_file_with_overwrite(SD, "/N" + String(chsn_slot) + "_ttl", dec_st);
  clear_variables();
  encrypt_with_TDES_AES_Blowfish_Serp(entered_content);
  delay(200);
  write_to_file_with_overwrite(SD, "/N" + String(chsn_slot) + "_cnt", dec_st);
  clear_variables();
  encr_hash_for_tdes_aes_blf_srp(entered_title + entered_content);
  delay(200);
  write_to_file_with_overwrite(SD, "/N" + String(chsn_slot) + "_tag", dec_st);
  return;
}
...
void update_note_and_tag(int chsn_slot, String new_content) {
  ...
  clear_variables();
  decrypt_with_TDES_AES_Blowfish_Serp(read_file(SD, "/N" + String(chsn_slot) + "_ttl"));
  String decrypted_title = dec_st;
...
void edit_note_from_keyboard_and_encdr(int chsn_slot) {
  if (read_file(SD, "/N" + String(chsn_slot) + "_cnt") == "-1") {
    tft.fillScreen(0x0000);
    tft.setTextColor(0x07e0);
    tft.setTextSize(2);
    disp_centered_text("The Slot N" + String(chsn_slot) + " is Empty", 5);
    ...
    clear_variables();
    decrypt_with_TDES_AES_Blowfish_Serp(read_file(SD, "/N" + String(chsn_slot) + "_cnt"));
    String old_password = dec_st;
    act = true;
    clear_variables();
...
void delete_note(int chsn_slot) {
  ...
  tft.setCursor(0, 10);
  tft.print("Please wait for a while.");
  delete_file(SD, "/N" + String(chsn_slot) + "_tag");
  delete_file(SD, "/N" + String(chsn_slot) + "_ttl");
  delete_file(SD, "/N" + String(chsn_slot) + "_cnt");
  clear_variables();
  call_main_menu();
  return;
}
...
void view_note(int chsn_slot) {
  if (read_file(SD, "/N" + String(chsn_slot) + "_ttl") == "-1") {
    tft.fillScreen(0x0000);
    tft.setTextColor(0x07e0);
    tft.setTextSize(2);
    disp_centered_text("The Slot N" + String(chsn_slot) + " is Empty", 5);
    ...
    clear_variables();
    decrypt_tag_with_TDES_AES_Blowfish_Serp(read_file(SD, "/N" + String(chsn_slot) + "_tag"));
...
void display_title_from_phone_number_without_integrity_verification() {
  tft.setTextSize(2);
  String encrypted_title = read_file(SD, "/P" + String(curr_key) + "_ttl");
  if (encrypted_title == "-1") {
    tft.setTextColor(0x07e0);
    disp_centered_text("Empty", 35);
  } else {
...
void write_phone_number_to_flash(int chsn_slot, String entered_title, String entered_phone_number) {
  ...
  encrypt_with_TDES_AES_Blowfish_Serp(entered_title);
  delay(200);
  write_to_file_with_overwrite(SD, "/P" + String(chsn_slot) + "_ttl", dec_st);
  clear_variables();
  encrypt_with_TDES_AES_Blowfish_Serp(entered_phone_number);
  delay(200);
  write_to_file_with_overwrite(SD, "/P" + String(chsn_slot) + "_cnt", dec_st);
  clear_variables();
  encr_hash_for_tdes_aes_blf_srp(entered_title + entered_phone_number);
  delay(200);
  write_to_file_with_overwrite(SD, "/P" + String(chsn_slot) + "_tag", dec_st);
  return;
}
...
void update_phone_number_and_tag(int chsn_slot, String new_phone_number) {
  ...
  clear_variables();
  decrypt_with_TDES_AES_Blowfish_Serp(read_file(SD, "/P" + String(chsn_slot) + "_ttl"));
  String decrypted_title = dec_st;
...
void edit_phone_number_from_keyboard_and_encdr(int chsn_slot) {
  if (read_file(SD, "/P" + String(chsn_slot) + "_cnt") == "-1") {
    tft.fillScreen(0x0000);
    tft.setTextColor(0x07e0);
    tft.setTextSize(2);
    disp_centered_text("The Slot N" + String(chsn_slot) + " is Empty", 5);
    ...
    clear_variables();
    decrypt_with_TDES_AES_Blowfish_Serp(read_file(SD, "/P" + String(chsn_slot) + "_cnt"));
    String old_password = dec_st;
    act = true;
    clear_variables();
...
void delete_phone_number(int chsn_slot) {
  ...
  tft.setCursor(0, 10);
  tft.print("Please wait for a while.");
  delete_file(SD, "/P" + String(chsn_slot) + "_tag");
  delete_file(SD, "/P" + String(chsn_slot) + "_ttl");
  delete_file(SD, "/P" + String(chsn_slot) + "_cnt");
  clear_variables();
  call_main_menu();
  return;
}
...
void view_phone_number(int chsn_slot) {
  if (read_file(SD, "/P" + String(chsn_slot) + "_ttl") == "-1") {
    tft.fillScreen(0x0000);
    tft.setTextColor(0x07e0);
    tft.setTextSize(2);
    disp_centered_text("The Slot N" + String(chsn_slot) + " is Empty", 5);
    ...
    clear_variables();
    decrypt_tag_with_TDES_AES_Blowfish_Serp(read_file(SD, "/P" + String(chsn_slot) + "_tag"));
...
void perform_factory_reset() {
  ...
  tft.print("Please wait for a while.");
  delay(1000);
  delete_file(SD, "/mpass");
  for (int i = 0; i < MAX_NUM_OF_RECS; i++) {
    delete_file(SD, "/L" + String(i + 1) + "_tag");
    delete_file(SD, "/L" + String(i + 1) + "_ttl");
    delete_file(SD, "/L" + String(i + 1) + "_usn");
    delete_file(SD, "/L" + String(i + 1) + "_psw");
    delete_file(SD, "/L" + String(i + 1) + "_wbs");
    delete_file(SD, "/C" + String(i + 1) + "_tag");
    delete_file(SD, "/C" + String(i + 1) + "_ttl");
    delete_file(SD, "/C" + String(i + 1) + "_hld");
    delete_file(SD, "/C" + String(i + 1) + "_nmr");
    delete_file(SD, "/C" + String(i + 1) + "_exp");
    delete_file(SD, "/C" + String(i + 1) + "_cvn");
    delete_file(SD, "/C" + String(i + 1) + "_pin");
    delete_file(SD, "/C" + String(i + 1) + "_zip");
    delete_file(SD, "/N" + String(i + 1) + "_tag");
    delete_file(SD, "/N" + String(i + 1) + "_ttl");
    delete_file(SD, "/N" + String(i + 1) + "_cnt");
    delete_file(SD, "/P" + String(i + 1) + "_tag");
    delete_file(SD, "/P" + String(i + 1) + "_ttl");
    delete_file(SD, "/P" + String(i + 1) + "_cnt");
    tft.fillScreen(0x0000);
    tft.setTextSize(1);
    tft.setTextColor(0xffff);
    tft.setCursor(0, 0);
...
void lock_scr_without_rfid(){
  ...
  tft.setTextColor(0xf7de);
  if (sd_mnt == true)
    disp_centered_text_b_w("Press Any Key", 209);
  else
