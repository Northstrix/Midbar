...
String nint_64_ctrl_ps2_keyb_inpt;
...
const uint16_t current_inact_clr = colors[0];
...
String kderalgs = "jM082C0o9DgDBluoyr51aGFySF88i075";
int numofkincr = 811;
byte hmackey[] = {"oMm2p2J7z9RdCH0bd2ZOfDo5ldD7ZGvcRjJwFMU2C9i2PqCGY4532B8g4UeIX6jDQJ6gm40DX8Elu2CGz2c3V37V8FKtd885A726XRGK5UN2R3CtRlm8r2c8rEEu4JP"};
byte des_key[] = {
0x3d,0x8b,0xb4,0x65,0xf6,0x6f,0xec,0x62,
0x65,0x28,0xeb,0x8c,0xab,0x0e,0xed,0x3b,
0x25,0xfa,0xf6,0x2e,0xb6,0xa6,0x5f,0xe4
};
uint8_t AES_key[32] = {
0xaa,0x13,0x78,0xe2,
0xba,0xec,0x45,0xd3,
...
void get_random_number() {
  ...
  delay(4);
  set_pins_for_n64_input();
}

int generate_random_number() {
  get_random_number();
  int rnd_number = i2c_data;
  int rnd_nmb_from_stm = gen_random_number_on_stm();
  int rslt_numb = rnd_number ^ rnd_nmb_from_stm;
  return rslt_numb;
}
...
String get_rfid_card() {
  ...
  while (finish_input == false) {
    inp_frm_cntr_and_ps2_kbrd = get_rfid_card_from_arduino();
...
byte get_rfid_card_from_arduino() {
  set_pins_for_rfid();
  byte rfid_data_from_arduino;
  while (rec_d == false) {
    delay(4);
  }
  if (rec_d == true) {
    rfid_data_from_arduino = i2c_data;
    rec_d = false;
  }
  return rfid_data_from_arduino;
}
...
byte get_Ni64_contr_and_PS2_keyb_input() {
  set_pins_for_n64_input();
  ...
  if (rec_d == true) {
    data_from_cntrl_and_keyb = i2c_data;
    rec_d = false;
  }
...
void check_bounds_and_change_char() {
  ...
  if (curr_key > 126)
    curr_key = 32;
  curr_key = nint_64_ctrl_ps2_keyb_inpt.charAt(nint_64_ctrl_ps2_keyb_inpt.length() - 1);
}
...
void disp() {
  ...
  tft.setTextSize(2);
  tft.setCursor(0, 48);
  tft.print(nint_64_ctrl_ps2_keyb_inpt);
}
...
void disp_stars() {
  ...
  tft.setTextColor(0x07e0);
  tft.print(hexstr);
  int plnt = nint_64_ctrl_ps2_keyb_inpt.length();
  String stars = "";
...
void nintendo_64_and_ps2_keyboard_controller_input() {
  ...
  byte inp_frm_cntr_and_ps2_kbrd = 0;
  while (finish_input == false) {
    inp_frm_cntr_and_ps2_kbrd = get_Ni64_contr_and_PS2_keyb_input();
    if (inp_frm_cntr_and_ps2_kbrd > 0) {
      if (inp_frm_cntr_and_ps2_kbrd > 31 && inp_frm_cntr_and_ps2_kbrd < 127) {
        curr_key = inp_frm_cntr_and_ps2_kbrd;
        nint_64_ctrl_ps2_keyb_inpt += char(curr_key);
        //Serial.println(nint_64_ctrl_ps2_keyb_inpt);
        disp();
      }
      ...
      if (inp_frm_cntr_and_ps2_kbrd == 132 || inp_frm_cntr_and_ps2_kbrd == 8) {
        if (nint_64_ctrl_ps2_keyb_inpt.length() > 0)
          nint_64_ctrl_ps2_keyb_inpt.remove(nint_64_ctrl_ps2_keyb_inpt.length() - 1, 1);
        //Serial.println(nint_64_ctrl_ps2_keyb_inpt);
...
void select_login(byte what_to_do_with_it) {
  ...
  while (continue_to_next == false) {
    byte input_data = get_Ni64_contr_and_PS2_keyb_input();
    if (input_data > 0) {
...
void enter_title_for_login(int chsn_slot) {
  ...
  if (act == true) {
    enter_username_for_login(chsn_slot, nint_64_ctrl_ps2_keyb_inpt);
  }
  return;
}
...
void enter_username_for_login(int chsn_slot, String entered_title) {
  ...
  nintendo_64_and_ps2_keyboard_controller_input();
  if (act == true) {
    enter_password_for_login(chsn_slot, entered_title, nint_64_ctrl_ps2_keyb_inpt);
  }
  return;
}
...
void enter_password_for_login(int chsn_slot, String entered_title, String entered_username) {
  ...
  nintendo_64_and_ps2_keyboard_controller_input();
  if (act == true) {
    enter_website_for_login(chsn_slot, entered_title, entered_username, nint_64_ctrl_ps2_keyb_inpt);
  }
  return;
}
...
void enter_website_for_login(int chsn_slot, String entered_title, String entered_username, String entered_password) {
  ...
  nintendo_64_and_ps2_keyboard_controller_input();
  if (act == true) {
    write_login_to_flash(chsn_slot, entered_title, entered_username, entered_password, nint_64_ctrl_ps2_keyb_inpt);
  }
  return;
}
...
void write_login_to_flash(int chsn_slot, String entered_title, String entered_username, String entered_password, String entered_website) {
  ...
  */
  display_lock_screen(gen_random_number_on_stm() % 3);
  tft.setTextSize(1);
  tft.setTextColor(0xffff);
...
void edit_login_from_nint_controller(int chsn_slot) {
  if (read_file("/L" + String(chsn_slot) + "_psw") == "-1") {
    ...
    nint_64_ctrl_ps2_keyb_inpt = old_password;
    disp();
    nintendo_64_and_ps2_keyboard_controller_input();
    if (act == true) {
      update_login_and_tag(chsn_slot, nint_64_ctrl_ps2_keyb_inpt);
    }
  }
  return;
}
...
void enter_title_for_credit_card(int chsn_slot) {
  ...
  nintendo_64_and_ps2_keyboard_controller_input();
  if (act == true) {
    enter_cardholder_for_credit_card(chsn_slot, nint_64_ctrl_ps2_keyb_inpt);
  }
  return;
}
...
void enter_cardholder_for_credit_card(int chsn_slot, String entered_title) {
  ...
  nintendo_64_and_ps2_keyboard_controller_input();
  if (act == true) {
    enter_card_number_for_credit_card(chsn_slot, entered_title, nint_64_ctrl_ps2_keyb_inpt);
  }
  return;
}
...
void enter_card_number_for_credit_card(int chsn_slot, String entered_title, String entered_cardholder) {
  ...
  nintendo_64_and_ps2_keyboard_controller_input();
  if (act == true) {
    enter_expiry_for_credit_card(chsn_slot, entered_title, entered_cardholder, nint_64_ctrl_ps2_keyb_inpt);
  }
  return;
}
...
void enter_expiry_for_credit_card(int chsn_slot, String entered_title, String entered_cardholder, String entered_card_number) {
  ...
  nintendo_64_and_ps2_keyboard_controller_input();
  if (act == true) {
    enter_cvn_for_credit_card(chsn_slot, entered_title, entered_cardholder, entered_card_number, nint_64_ctrl_ps2_keyb_inpt);
  }
  return;
}
...
void enter_cvn_for_credit_card(int chsn_slot, String entered_title, String entered_cardholder, String entered_card_number, String entered_expiry) {
  ...
  nintendo_64_and_ps2_keyboard_controller_input();
  if (act == true) {
    enter_pin_for_credit_card(chsn_slot, entered_title, entered_cardholder, entered_card_number, entered_expiry, nint_64_ctrl_ps2_keyb_inpt);
  }
  return;
}
...
void enter_pin_for_credit_card(int chsn_slot, String entered_title, String entered_cardholder, String entered_card_number, String entered_expiry, String entered_cvn) {
  ...
  nintendo_64_and_ps2_keyboard_controller_input();
  if (act == true) {
    enter_zip_code_for_credit_card(chsn_slot, entered_title, entered_cardholder, entered_card_number, entered_expiry, entered_cvn, nint_64_ctrl_ps2_keyb_inpt);
  }
  return;
}
...
void enter_zip_code_for_credit_card(int chsn_slot, String entered_title, String entered_cardholder, String entered_card_number, String entered_expiry, String entered_cvn, String entered_pin) {
  ...
  nintendo_64_and_ps2_keyboard_controller_input();
  if (act == true) {
    write_credit_card_to_flash(chsn_slot, entered_title, entered_cardholder, entered_card_number, entered_expiry, entered_cvn, entered_pin, nint_64_ctrl_ps2_keyb_inpt);
  }
  return;
}
...
void edit_credit_card_from_nint_controller(int chsn_slot) {
  if (read_file("/C" + String(chsn_slot) + "_pin") == "-1") {
    ...
    nint_64_ctrl_ps2_keyb_inpt = old_pin;
    disp();
    nintendo_64_and_ps2_keyboard_controller_input();
    if (act == true) {
      update_credit_card_and_tag(chsn_slot, nint_64_ctrl_ps2_keyb_inpt);
    }
  }
  return;
}
...
void enter_title_for_note(int chsn_slot) {
  ...
  nintendo_64_and_ps2_keyboard_controller_input();
  if (act == true) {
    enter_content_for_note(chsn_slot, nint_64_ctrl_ps2_keyb_inpt);
  }
  return;
}
...
void enter_content_for_note(int chsn_slot, String entered_title) {
  ...
  nintendo_64_and_ps2_keyboard_controller_input();
  if (act == true) {
    write_note_to_flash(chsn_slot, entered_title, nint_64_ctrl_ps2_keyb_inpt);
  }
  return;
}
...
void edit_note_from_nint_controller(int chsn_slot) {
  if (read_file("/N" + String(chsn_slot) + "_cnt") == "-1") {
    ...
    nintendo_64_and_ps2_keyboard_controller_input();
    if (act == true) {
      update_note_and_tag(chsn_slot, nint_64_ctrl_ps2_keyb_inpt);
    }
  }
  return;
}
...
void enter_title_for_phone_number(int chsn_slot) {
  ...
  nintendo_64_and_ps2_keyboard_controller_input();
  if (act == true) {
    enter_phone_number_for_phone_number(chsn_slot, nint_64_ctrl_ps2_keyb_inpt);
  }
  return;
}
...
void enter_phone_number_for_phone_number(int chsn_slot, String entered_title) {
  ...
  nintendo_64_and_ps2_keyboard_controller_input();
  if (act == true) {
    write_phone_number_to_flash(chsn_slot, entered_title, nint_64_ctrl_ps2_keyb_inpt);
  }
  return;
}
...
void edit_phone_number_from_nint_controller(int chsn_slot) {
  if (read_file("/P" + String(chsn_slot) + "_cnt") == "-1") {
    ...
    nintendo_64_and_ps2_keyboard_controller_input();
    if (act == true) {
      update_phone_number_and_tag(chsn_slot, nint_64_ctrl_ps2_keyb_inpt);
    }
  }
  return;
}
...
void display_lock_screen(byte ch_lock_sc){
  tft.fillScreen(0x0000);
  if (ch_lock_sc == 0){
    for (int i = 0; i < 320; i++) {
      for (int j = 0; j < 190; j++) {
...
void set_pass() {
  ...
  //Serial.println(nint_64_ctrl_ps2_keyb_inpt);
  String bck = nint_64_ctrl_ps2_keyb_inpt;
  modify_keys();
  nint_64_ctrl_ps2_keyb_inpt = bck;
  set_psswd();
  tft.fillScreen(0x0000);
  tft.setTextSize(2);
  draw_47px_midbar_inscription();
...
void set_psswd() {
  int str_len = nint_64_ctrl_ps2_keyb_inpt.length() + 1;
  char input_arr[str_len];
  nint_64_ctrl_ps2_keyb_inpt.toCharArray(input_arr, str_len);
  std::string str = "";
  if (str_len > 1) {
...
void modify_keys() {
  nint_64_ctrl_ps2_keyb_inpt += kderalgs;
  int str_len = nint_64_ctrl_ps2_keyb_inpt.length() + 1;
  char input_arr[str_len];
  nint_64_ctrl_ps2_keyb_inpt.toCharArray(input_arr, str_len);
  std::string str = "";
...
void hash_with_sha256() {
  ...
  nint_64_ctrl_ps2_keyb_inpt.toCharArray(keyb_inp_arr, str_len);
  SHA256 hasher;
...
void set_pins_for_n64_input(){
  digitalWrite(PD9, LOW);
  digitalWrite(PE15, LOW);
}

void set_pins_for_rng(){
  digitalWrite(PD9, HIGH);
  digitalWrite(PE15, LOW);
}

void set_pins_for_rfid(){
  digitalWrite(PD9, LOW);
  digitalWrite(PE15, HIGH);
}

void approx_rfid_cards(){
  byte chosen_lock_screen = gen_random_number_on_stm() % 3;
  byte new_screen;
  display_lock_screen(chosen_lock_screen);
  disp_centered_text("Midbar STM32F407VET6", 4);
  disp_centered_text_b_w("Tap RFID Card N1", 220);
  read_card1 = get_rfid_card();
  new_screen = chosen_lock_screen;
  while (chosen_lock_screen == new_screen){
    new_screen = gen_random_number_on_stm() % 3;
    delayMicroseconds(120);
  }
  chosen_lock_screen = new_screen;
  display_lock_screen(chosen_lock_screen);
  disp_centered_text("Midbar STM32F407VET6", 4);
  disp_centered_text_b_w("Tap RFID Card N2", 220);
  read_card2 = get_rfid_card();
  new_screen = chosen_lock_screen;
  while (chosen_lock_screen == new_screen){
    new_screen = gen_random_number_on_stm() % 3;
    delayMicroseconds(120);
  ...
  display_lock_screen(chosen_lock_screen);
  disp_centered_text("Midbar STM32F407VET6", 4);
  disp_centered_text_b_w("Tap RFID Card N3", 220);
  read_card3 = get_rfid_card();
  new_screen = chosen_lock_screen;
  while (chosen_lock_screen == new_screen){
    new_screen = gen_random_number_on_stm() % 3;
    delayMicroseconds(120);
  ...
  display_lock_screen(chosen_lock_screen);
  disp_centered_text("Midbar STM32F407VET6", 4);
  disp_centered_text_b_w("Tap RFID Card N4", 220);
  read_card4 = get_rfid_card();
}
...
void setup(void) {
  ...
  if (sd_crd_int == true)
    ...
    display_lock_screen(gen_random_number_on_stm() % 3);
    disp_centered_text("Midbar STM32F407VET6", 4);
    disp_centered_text_b_w("No SD Card", 220);
    while (1){
      delay(1000);
    }
  }
