...
String kderalgs = "tQ0hNaj4oF3i9E4kG63dUXa047BL8L";
byte hmackey[] = {"96xlXnkZ23Gte8Idk6e7Z8gl1RH5n20tYKWftTGt0Y6r0Ir2mgTRazW6Po99TP8N7f0csHkI4kxano7n9XwK85vX3KccyDNi489BaL35nbYg57c41E0tjP97h"};
uint8_t AES_key[32] = {
0xc6,0x0d,0xfe,0xcf,
0x0f,0xcb,0x26,0xf3,
0xed,0xc1,0xea,0x44,
...
void setup() {
  ...
  pinMode(3, OUTPUT);
  digitalWrite(3, LOW);
  disp_random_lock_scr(generate_random_number() % 12);
  press_any_key_to_continue();
