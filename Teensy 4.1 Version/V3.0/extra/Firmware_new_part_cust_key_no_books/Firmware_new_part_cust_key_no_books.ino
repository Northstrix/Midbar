...
// You can repartition the field sizes as long as the sum of all three values is 96
DES des;
Blowfish blowfish;
...
byte read_cards[16] = {
0x19,0x7f,0xda,0x9b,0x72,0xb8,0xe4,0xc4,
0x5f,0xe5,0xdd,0x1b,0x73,0xa0,0x25,0xbe
};
