...
bool display_pattern_while_adding_record = true;
...
void display_background_while_adding_record(){
  if (display_pattern_while_adding_record == true){
    byte chosen_pattern = esp_random() % 3;
    if (chosen_pattern == 0){
...
void display_lock_screen() {
  chosen_lock_screen = esp_random() % 10;
